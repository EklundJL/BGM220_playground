 ...
 * (P25 on BRD4001 J102) as input. JAE- changed to pin PC0
 *******************************************************************************
 * # License
 * <b>Copyright 2020 Silicon Laboratories Inc. www.silabs.com</b>
 *******************************************************************************
...
void initPRS(void)
{
  ...
  PRS_SourceAsyncSignalSet(6, PRS_ASYNC_CH_CTRL_SOURCESEL_IADC0,
                           PRS_ASYNC_CH_CTRL_SIGSEL_IADC0SINGLEDONE);

  // Route PRS channel 0 to PB1 to indicate a conversion complete
  PRS_PinOutput(0,prsTypeAsync, gpioPortB, 1);
  PRS_PinOutput(6,prsTypeAsync, gpioPortC, 1); //JAE test
}
